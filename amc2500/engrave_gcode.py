...
def main():
    ...
    for path in args.files:
        if path == "TC":
            ...
            with open(path) as f:
                ...
                except gcode_parse.ParserException as err:
    ...
    go = ""
    while go != "GO":
        go = input("Type GO and press enter to start the engraving pass... ")
    ...
    try:
        while True:
            ...
            if c == 'j':
                ...
                width = input("Enter the isolation width to test in mm (engraver will make two parallel 15mm lines this far apart.)\n> ")
                try:
                    width = float(width)
